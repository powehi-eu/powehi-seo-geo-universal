...
- **Cross-ref**: `/powehi-seo schema <url>`
...
- **Cross-ref**: `/powehi-seo technical <url>`
...
- **Cross-ref**: `/powehi-seo content <url>`
...
- **Cross-ref**: `/powehi-seo google psi <url>`
...
- **Action**: Positive change. Validate the new schema with `/powehi-seo schema <url>`.
- **Cross-ref**: `/powehi-seo schema <url>`
