...
Configure with: `powehi-seo-geo run dataforseo_costs.py config --mode threshold --threshold 0.50 --daily-limit 10.00`
...
1. Run `powehi-seo-geo run dataforseo_costs.py check <endpoint> [--count N]`
...
5. After call completes, log: `powehi-seo-geo run dataforseo_costs.py log <endpoint> <cost>`
