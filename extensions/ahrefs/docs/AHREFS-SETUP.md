> **Languages:** [Français](AHREFS-SETUP.fr.md) | English
...
4. Copies `skills/seo-ahrefs/SKILL.md` into `~/.claude/skills/powehi-seo-ahrefs/`.
...
`scripts/dataforseo_costs.py` cost tracker shipped with powehi-seo-geo
...
| 401 from any `/powehi-seo ahrefs *` command | Token revoked / expired | Generate a new token at https://ahrefs.com/api and re-run the installer |
