...
def _build_title_page(domain, report_title, subtitle, score=None, score_label=None, meta_items=None):
    ...
    return (
        ...
        f'  <h1>{domain}</h1>\n'
        f'  <div class="subtitle">Prepared by Powehi Universal SEO</div>\n'
        f'{score_html}'
        f'{meta_html}'
        f'{google_logo_html}'
        f'</div>\n'
...
def _build_methodology_footer(domain, timestamp, gsc_warning=""):
    ...
    return (
        ...
        f'    Report generated by Powehi Universal SEO &mdash; Google SEO Intelligence Skill &mdash; '
        f'{timestamp}<br>\n'
...
def generate_report(report_type, data, domain, output_dir, output_format="pdf"):
    ...
    base_name = f"Powehi-SEO-Audit-{safe_domain}-{report_type}"
...
def generate_xlsx(data, domain, report_type, output_dir):
    ...
    filename = f"Powehi-SEO-Audit-{domain}-{timestamp}.xlsx"
